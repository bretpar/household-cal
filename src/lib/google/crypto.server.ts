/**
 * Encryption for the per-household Google connection handle.
 *
 * The `lovack_*` connection key never leaves the server and is only ever stored
 * as ciphertext, so nobody browsing the database sees a usable credential.
 */
