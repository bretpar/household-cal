 ...
 *
 * Safe Google maintenance tools (diagnostic, recurrence repair, backfill) live
 * in the owner-facing `GoogleCalendarMaintenance` section instead; only
 * destructive QA tooling belongs here.
 */
